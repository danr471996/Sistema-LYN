...
CREATE TABLE `facturas_proveedor` (
  `idFacturas_proveedor` int(11) NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`idFacturas_proveedor`),
  KEY `fk_proveedor_idx` (`Id_proveedor`),
  CONSTRAINT `fk_proveedor` FOREIGN KEY (`Id_proveedor`) REFERENCES `proveedor` (`IdProveedor`)
