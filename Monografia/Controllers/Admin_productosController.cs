    ...
    public class Admin_productosController : Controller
    {
        ...
        public ActionResult Create()
        {
            try
            {
                ...
                modelo_contenedor.listatipopresentacion = new List<tipo_presentacion>();
                modelo_contenedor.listadepartamento = getdepartamentos();
                modelo_contenedor.listaproveedor = getproveedor();
                modelo_contenedor.listatipopresentacion = gettipopresentacion();
        ...
        public List<tipo_presentacion> gettipopresentacion()
        {
            return (from u in db.tipo_presentacion where u.Estado == 1 select u).ToList();
        }
                ...
                if (id != 0 && id != null)
                {
                    ...
                    else
                    {
                        ...
                        modelocontenedor = new Modelo_contenedor
                        {
                           ...
                           listatipopresentacion = new List<tipo_presentacion>()
                        };
                        ...
                        modelocontenedor.listatipopresentacion = gettipopresentacion();
              ...
              ViewBag.usainventario = usainventario == "true" ? true:false ;
                ...
                if (validadinputs(datosproductoedit, usainventario,null))
                {
                    ...
                    if (producto == null)
                    {
                        ...
                        datosproductoedit.listatipopresentacion = new List<tipo_presentacion>();
                        datosproductoedit.listadepartamento = getdepartamentos();
                        datosproductoedit.listaproveedor = getproveedor();
                        datosproductoedit.listatipopresentacion = gettipopresentacion();
