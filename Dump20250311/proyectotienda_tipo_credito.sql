...
CREATE TABLE `tipo_credito` (
  `Id_tipocredito` int NOT NULL AUTO_INCREMENT,
...
INSERT INTO `tipo_credito` VALUES (1,'2022-09-11 00:00:00','danr',NULL,NULL,'Sin limites',1),(2,'2022-09-11 00:00:00','danr',NULL,NULL,'Con limites',1);
