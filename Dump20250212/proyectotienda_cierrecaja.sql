...
CREATE TABLE `cierrecaja` (
  `idCierreCaja` int NOT NULL AUTO_INCREMENT,
  `Fecha_alta` datetime NOT NULL,
  `Usuario_alta` varchar(45) NOT NULL,
  `Fecha_baja` datetime DEFAULT NULL,
  `Usuario_baja` varchar(45) DEFAULT NULL,
  `Total_efectivo` decimal(15,2) NOT NULL,
  `Total_crédito` decimal(15,2) NOT NULL,
  `Estado` int NOT NULL COMMENT '1-aprobado\n2-pendiente aprobación',
...
INSERT INTO `cierrecaja` VALUES (1,'2025-01-14 16:02:38','danr',NULL,NULL,0.00,0.00,1);
